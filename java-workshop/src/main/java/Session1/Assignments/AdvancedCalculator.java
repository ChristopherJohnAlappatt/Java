    ...
    public static void main(String[] args) {
        ...
        while (choice != 5) {
            ...
            switch (choice) {
                ...
                case 2:
                    System.out.printf("The subtraction of %.2f and %.2f is %.2f", num_1, num_2, num_1 - num_2);
                    break;
                case 3:
                    System.out.printf("The product of %.2f and %.2f is %.2f", num_1, num_2, num_1 * num_2);
                    break;
                case 4:
                    System.out.printf("The division of %.2f and %.2f is %.2f", num_1, num_2, num_1 / num_2);
                    break;
                case 5:
